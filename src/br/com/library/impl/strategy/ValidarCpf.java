...
public class ValidarCpf implements IStrategy {
	...
	public String processar(EntidadeDominio entidade) {
		...
		if (nmClasse.equals(Cliente.class.getName()))
			return verificarCPFCliente(entidade);
		else 
			return verificarCPFClienteDTO(entidade);
		
	}
	private String verificarCPFCliente(EntidadeDominio entidade) {
Cliente cliente = (Cliente)entidade;
	...
	private String verificarCPFClienteDTO(EntidadeDominio entidade) {
